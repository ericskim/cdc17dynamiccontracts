...
f=open("MPC_decentralized.txt","w")
g=open("MPC_decentralized_controls.txt","w")
def one_step_evolution(clock,k):
    global total_run
    global max_run
    c={}
    for n in [1,2,3,4]:
        (runtime,states,controls)=SubNetwork[n].MPC_MTL_Subnetwork(H,T,clock,demand_subs[n],x_terminal,u_terminal,y,output_subnetwork[n],output_turn,upstream,x_history,u_history)        
        c[n]=controls
